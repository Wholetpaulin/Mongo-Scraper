...
$(document).ready(function() {
  ...
  function renderNotesList(data) {
       console.log("renderNotesListData: " + JSON.stringify(data));
    ...
    if (data.notes.length === 0) {
         console.log("it thinks there are no notes");
  ...
  function handleArticleNotes() {
    ...
    console.log("panel this:" + JSON.stringify($(this).parents(".panel").data()));
    ...
    $.get("/api/notes/" + currentArticle._id).then(function(data) {
      ...
      var modalText = [
        ...
        "</ul>",
        "<textarea placeholder='New Note' rows='4' cols='60' data-article='" + currentArticle._id +"'></textarea>",
  ...
  function handleNoteSave() {
       console.log("handleNoteSaved was clicked");
    // This function handles what happens when a user tries to save a new note for an article
    // Setting a variable to hold some formatted data about our note,
    // grabbing the note typed into the input box
    var noteData;
    var newNote = $(".bootbox-body textarea").val().trim();
    var articleId = $(".bootbox-body textarea").attr("data-article");
    ...
    if (newNote) {
      noteData = {
        ...
        articleIdColumn: articleId,
        noteText: newNote
      };
      console.log("noteData on front end:" + JSON.stringify(noteData));
      $.post("/api/notes", noteData).then(function() {
           console.log("handleNoteSaved $.post ran");
